...
class BlackPufferJacketFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_black_puffer_jacket, container, false)
        ...
        backButton.setOnClickListener {
            // Navigate back to the VirtualTryOnPageFragment
    ...
    private fun setupWebView() {
        ...
        webView.loadUrl("https://flowcode.com/p/eaUqiKmK0y")
    }
